                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
                    ...
                    <a class="dropdown-item">
                        <div class="item-thumbnail">
                            <img src="/admino/images/faces/face4.jpg" alt="image" class="profile-pic">
                        </div>
                        <div class="item-content flex-grow">
                            <h6 class="ellipsis font-weight-normal"> Faysal Mahmud
                            </h6>
                    ...
                    <a class="dropdown-item">
                        <div class="item-thumbnail">
                            <img src="/admino/images/faces/face2.jpg" alt="image" class="profile-pic">
                        </div>
                        <div class="item-content flex-grow">
                            <h6 class="ellipsis font-weight-normal"> Ashrarul Haque Sifat
                            </h6>
                            <p class="font-weight-light small-text text-muted mb-0">
                                New product launch
                            </p>
                    ...
                    <a class="dropdown-item">
                        <div class="item-thumbnail">
                            <img src="/admino/images/faces/face3.jpg" alt="image" class="profile-pic">
                        </div>
                        <div class="item-content flex-grow">
                            <h6 class="ellipsis font-weight-normal"> JIqbal Mahamud
                            </h6>
                            <p class="font-weight-light small-text text-muted mb-0">
